...
if __name__ == "__main__":
    ...
    # nnU-Netの環境変数を設定
    os.environ['nnUNet_raw'] = r'\\scallop\User\ogura\nnUNet\datasets\nnUnet_raw'
    os.environ['nnUNet_preprocessed'] = r'\\scallop\User\ogura\nnUNet\datasets\nnUnet_preprocessed'
    os.environ['nnUNet_results'] = r'\\scallop\User\ogura\nnUNet\datasets\nnUnet_reselts_2'
    ...
    from nnunetv2.experiment_planning.plan_and_preprocess_api import extract_fingerprints, plan_experiments_CV, preprocess
    ...
    print(args.d, args.fpe, args.npfp, args.verify_dataset_integrity, args.clean, args.verbose)
    ...
    plans_identifier = plan_experiments_CV(args.d, args.pl, args.gpu_memory_target, args.preprocessor_name,
